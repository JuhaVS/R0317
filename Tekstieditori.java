...
public class Tekstieditori extends JFrame {
	...
	public Tekstieditori() {
		...
		// Lis‰t‰‰n avaa painikkeelle kuuntelija, jonka avulla voi valita mik‰ tiedosto
		// avataan
		...
		// Etsi napille kuuntelija, jota painettaessa luodaan uusi ikkuna jolla voidaan
		// etsi‰ sanaa. Helpompi varmaankin showInputDialogilla mutta olin jo tehnyt
		// t‰ll‰ tavalla
		...
		mntmEtsi.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					ok.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							try {
								...
								Scanner lukija = new Scanner(sisalto);
								...
								for (int index = 0; index + haettava.length() < sisalto.length(); index++) {
									...
									if (haettava.equals(match)) {
										DefaultHighlighter.DefaultHighlightPainter highlightPainter = new DefaultHighlighter.DefaultHighlightPainter(
												Color.YELLOW);
										editorPane.getHighlighter().addHighlight(index, index + haettava.length(),
												highlightPainter);
					...
					// Etsi sanaa ikkunan peruuta nappi joka sulkee etsi ikkunan ja poistaa highlightit
		...
		// Korvaa napille kuuntelija, jota painettaessa luodaan uusi ikkuna jolla
		// voidaan korvata joku sana toisella. Varmaan helpompi myˆs showInputDialogilla
		...
		// toolbar ja sen pikakuvakkeet. Sek‰ niiden toiminnot jotka ovat samoja kun
		// valikossa
