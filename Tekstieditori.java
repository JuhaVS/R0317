						...
						public void actionPerformed(ActionEvent arg0) {
							try {
								...
								while (lukija.hasNextLine()) {
									...
									// setselection ei toiminut kunnolla while sisällä niin piti laittaa break tai muuten värjäys saattoi seota mikäli etsittäviä sanoja sattui olemaan useampi
